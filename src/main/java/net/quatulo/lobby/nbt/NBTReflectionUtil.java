...
public class NBTReflectionUtil {
    ...
    public static Object readNBTFile(FileInputStream stream) {
        try {
            return ReflectionMethod.NBTFILE_READ.run((Object)null, new Object[]{stream});
        } catch (Exception var2) {
            var2.printStackTrace();
            return null;
        }
    ...
    public static Object saveNBTFile(Object nbt, FileOutputStream stream) {
        try {
            return ReflectionMethod.NBTFILE_WRITE.run((Object)null, new Object[]{nbt, stream});
    ...
    public static Object getTileEntityNBTTagCompound(BlockState tile) {
        try {
            Object pos = ObjectCreator.NMS_BLOCKPOSITION.getInstance(new Object[]{tile.getX(), tile.getY(), tile.getZ()});
            ...
            Object o = ReflectionMethod.NMS_WORLD_GET_TILEENTITY.run(nmsworld, new Object[]{pos});
            Object tag = ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz().newInstance();
            Object answer = ReflectionMethod.TILEENTITY_GET_NBT.run(o, new Object[]{tag});
            if (answer == null) {
                answer = tag;
            }
    ...
    public static void addOtherNBTCompound(NBTCompound comp, NBTCompound nbtcompound) {
        ...
        if (valideCompound(comp)) {
            ...
            try {
                ReflectionMethod.COMPOUND_ADD.run(workingtag, new Object[]{nbtcompound.getCompound()});
