...
public class NBTCompound {
    ...
    public byte[] getByteArray(String key) {
        return (byte[])((byte[])NBTReflectionUtil.getData(this, ReflectionMethod.COMPOUND_GET_BYTEARRAY, key));
    }
    ...
    public int[] getIntArray(String key) {
        return (int[])((int[])NBTReflectionUtil.getData(this, ReflectionMethod.COMPOUND_GET_INTARRAY, key));
    }
    ...
    public NBTCompound getCompound(String name) {
        ...
        return NBTReflectionUtil.valideCompound(next) ? next : null;
    }
    ...
    public NBTType getType(String name) {
        if (MinecraftVersion.getVersion() == MinecraftVersion.MC1_7_R4) {
            ...
            return o == null ? null : NBTType.valueOf((Byte)o);
        }
    }
    ...
    public String toString(String key) {
        ...
        return this.getType(key) == NBTType.NBTTagCompound ? this.getCompound(key).toString() : result + "-" + key + ": " + this.getContent(key) + System.lineSeparator();
    }
