...
public enum ReflectionMethod {
    ...
    COMPOUND_ADD(ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz(), new Class[]{ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz()}, MinecraftVersion.MC1_7_R4, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "a")}),
    ...
    LIST_REMOVE_KEY(ClassWrapper.NMS_NBTTAGLIST.getClazz(), new Class[]{Integer.TYPE}, MinecraftVersion.MC1_7_R4, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "a"), new Since(MinecraftVersion.MC1_9_R1, "remove")}),
    LIST_SIZE(ClassWrapper.NMS_NBTTAGLIST.getClazz(), new Class[0], MinecraftVersion.MC1_7_R4, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "size")}),
    LIST_SET(ClassWrapper.NMS_NBTTAGLIST.getClazz(), new Class[]{Integer.TYPE, ClassWrapper.NMS_NBTBASE.getClazz()}, MinecraftVersion.MC1_7_R4, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "a"), new Since(MinecraftVersion.MC1_13_R1, "set")}),
    LEGACY_LIST_ADD(ClassWrapper.NMS_NBTTAGLIST.getClazz(), new Class[]{ClassWrapper.NMS_NBTBASE.getClazz()}, MinecraftVersion.MC1_7_R4, MinecraftVersion.MC1_13_R2, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "add")}),
    LIST_ADD(ClassWrapper.NMS_NBTTAGLIST.getClazz(), new Class[]{Integer.TYPE, ClassWrapper.NMS_NBTBASE.getClazz()}, MinecraftVersion.MC1_14_R1, new Since[]{new Since(MinecraftVersion.MC1_14_R1, "add")}),
    LIST_GET_STRING(ClassWrapper.NMS_NBTTAGLIST.getClazz(), new Class[]{Integer.TYPE}, MinecraftVersion.MC1_7_R4, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "getString")}),
    LIST_GET(ClassWrapper.NMS_NBTTAGLIST.getClazz(), new Class[]{Integer.TYPE}, MinecraftVersion.MC1_7_R4, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "get")}),
    ...
    CRAFT_WORLD_GET_HANDLE(ClassWrapper.CRAFT_WORLD.getClazz(), new Class[0], MinecraftVersion.MC1_7_R4, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "getHandle")}),
    NMS_WORLD_GET_TILEENTITY(ClassWrapper.NMS_WORLD.getClazz(), new Class[]{ClassWrapper.NMS_BLOCKPOSITION.getClazz()}, MinecraftVersion.MC1_7_R4, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "getTileEntity")}),
    TILEENTITY_GET_NBT(ClassWrapper.NMS_TILEENTITY.getClazz(), new Class[]{ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz()}, MinecraftVersion.MC1_8_R3, new Since[]{new Since(MinecraftVersion.MC1_8_R3, "b"), new Since(MinecraftVersion.MC1_9_R1, "save")}),
    TILEENTITY_SET_NBT(ClassWrapper.NMS_TILEENTITY.getClazz(), new Class[]{ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz()}, MinecraftVersion.MC1_8_R3, new Since[]{new Since(MinecraftVersion.MC1_8_R3, "a"), new Since(MinecraftVersion.MC1_12_R1, "load")}),
    CRAFT_ENTITY_GET_HANDLE(ClassWrapper.CRAFT_ENTITY.getClazz(), new Class[0], MinecraftVersion.MC1_7_R4, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "getHandle")}),
    NMS_ENTITY_SET_NBT(ClassWrapper.NMS_ENTITY.getClazz(), new Class[]{ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz()}, MinecraftVersion.MC1_8_R3, new Since[]{new Since(MinecraftVersion.MC1_8_R3, "f")}),
    NMS_ENTITY_GET_NBT(ClassWrapper.NMS_ENTITY.getClazz(), new Class[]{ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz()}, MinecraftVersion.MC1_8_R3, new Since[]{new Since(MinecraftVersion.MC1_8_R3, "e"), new Since(MinecraftVersion.MC1_12_R1, "save")}),
    NBTFILE_READ(ClassWrapper.NMS_NBTCOMPRESSEDSTREAMTOOLS.getClazz(), new Class[]{InputStream.class}, MinecraftVersion.MC1_7_R4, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "a")}),
    NBTFILE_WRITE(ClassWrapper.NMS_NBTCOMPRESSEDSTREAMTOOLS.getClazz(), new Class[]{ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz(), OutputStream.class}, MinecraftVersion.MC1_7_R4, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "a")}),
